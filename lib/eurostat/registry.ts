...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    description:
      "Demand, occupancy, capacity, turnover and prices across Europe's hotels and tourist accommodation — for operators and analysts.",
    icon: "BedDouble",
    accent: "#a14a3a",
    ...
    metrics: [
      ...
      },
      {
        id: "intl-nights",
        datasetCode: "tour_occ_nim",
        title: "International guest nights",
        short: "Int'l nights",
        description:
          "Nights spent by foreign (non-resident) guests at hotels — inbound demand.",
        filters: { freq: "M", c_resid: "FOR", unit: "NR", nace_r2: "I551" },
        unit: "nights",
        format: "compact",
        frequency: "M",
        trend: "up-good",
      },
      {
        ...
        filters: { freq: "A", accomunit: "BEDPL", hotelsize: "TOTAL", unit: "PC" },
        unit: "%",
        format: "percent",
        decimals: 1,
        frequency: "A",
      ...
      },
      {
        id: "establishments",
        datasetCode: "tour_cap_nat",
        title: "Hotel establishments",
        short: "Establishments",
        description:
          "Number of hotels and similar accommodation establishments.",
        filters: { accomunit: "ESTBL", unit: "NR", nace_r2: "I551" },
        unit: "establishments",
        format: "compact",
        frequency: "A",
        trend: "neutral",
      ...
      {
        id: "platform-nights",
        datasetCode: "tour_ce_omn12",
        title: "Platform short-stay nights",
        short: "Platform nights",
        description:
          "Guest nights in short-stay accommodation offered via collaborative economy platforms.",
        filters: {
          freq: "A",
          indic_to: "NGT_SP",
          c_resid: "TOTAL",
      ...
      {
        id: "accommodation-prices",
        datasetCode: "prc_hicp_manr",
        title: "Accommodation price inflation",
        short: "Accom. prices",
        description:
          "Annual change in consumer prices for accommodation services (HICP).",
        filters: { coicop: "CP112" },
        unit: "%",
        format: "percent",
        decimals: 1,
        frequency: "M",
      ...
      {
        id: "restaurant-prices",
        datasetCode: "prc_hicp_manr",
        title: "Restaurant & café price inflation",
        short: "Dining prices",
        description:
          "Annual change in consumer prices for catering services (HICP).",
      ...
      {
        id: "services-confidence",
        datasetCode: "ei_bsse_m_r2",
        title: "Services confidence",
        short: "Confidence",
        description:
          "Services confidence indicator from the European business survey.",
        filters: { freq: "M", indic: "BS-SCI", s_adj: "SA", unit: "BAL" },
        unit: "balance points",
        format: "decimal",
        decimals: 1,
        frequency: "M",
      ...
      {
        id: "hospitality-labour-growth",
        datasetCode: "lc_lci_r2_q",
        title: "Hospitality labour cost growth",
        short: "Labour growth",
        description:
          "Annual change in labour costs for accommodation and food service activities.",
        filters: {
          freq: "Q",
          s_adj: "CA",
          unit: "PCH_SM",
      ...
      {
        id: "hospitality-labour-cost",
        datasetCode: "lc_lci_lev",
        title: "Hospitality hourly labour cost",
        short: "Labour €/h",
        description:
          "Hourly labour cost level for accommodation and food service activities.",
        filters: {
          freq: "A",
          unit: "EUR",
          lcstruct: "D1_D4_MD5",
